...
const CONCEPTS: ConceptCard[] = [
  {
    ...
    child: (
      <div className="space-y-2 text-sm text-foreground">
        ...
        <div className="mt-3 rounded-md bg-zinc-900 p-3 font-mono text-xs text-zinc-100 whitespace-pre-wrap">
  ...
  },
  {
    ...
    child: (
      <div className="space-y-2 text-sm text-foreground">
        ...
        <div className="mt-3 rounded-md bg-amber-950/30 light:bg-zinc-50 border border-amber-800/40 light:border-zinc-200 p-3 text-xs text-amber-300 light:text-zinc-600">
    ...
    dev: (
      <div className="space-y-2 text-sm text-foreground">
        <p>
          React는{" "}
          <span className="font-mono text-indigo-400 light:text-zinc-700">Object.is(prev, next)</span>
          {" "}로 이전/다음 상태를 비교합니다.
        </p>
        <p>
  ...
  },
  {
    ...
    dev: (
      <div className="space-y-2 text-sm text-foreground">
        <p>
          Immer는 <span className="font-mono text-indigo-400 light:text-zinc-700">produce()</span>
...
export function Stage01Theory() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h3 className="text-lg font-semibold text-foreground">불변성 & Immer 이론</h3>
