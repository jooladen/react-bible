        ...
        <motion.div
          ...
          className={cn(
            ...
            currentTab.variant === "deepdive"
              ? (isDesktop ? "flex-1 overflow-auto" : "overflow-auto")
              : "overflow-auto border-b border-border"
          )}
        >
      ...
      {currentTab.variant !== "deepdive" && (
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className={isDesktop ? "flex flex-1 flex-col overflow-auto md:flex-row" : "flex flex-col"}
          >
            ...
            <div
              className={cn(
                isDesktop ? "flex-1 overflow-auto border-b border-border p-3 pb-6 md:border-b-0 md:p-6" : "border-b border-border p-3 pb-6",
            ...
            {currentTab.code && currentTab.code.length > 0 && (
              <div
                className={cn(
                  isDesktop ? "flex flex-1 flex-col p-3 md:p-6" : "flex flex-col p-3",
              ...
              >
                ...
                <div className="relative flex-1">
                  ...
                  <pre className={`${isDesktop ? "h-full" : "min-h-[200px]"} overflow-auto rounded-lg bg-zinc-900 p-4 font-mono text-xs leading-relaxed text-zinc-100 whitespace-pre-wrap light:bg-zinc-50 light:text-zinc-800`}>
                    {buildSnippetText(
                      currentTab.code[activeCode]?.snippet ?? "",
                      currentTab.code[activeCode]?.useClient
                    )}
